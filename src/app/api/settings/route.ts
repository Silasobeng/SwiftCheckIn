...
export async function GET() {
  ...
  try {
    ...
    const { data: organization, error: orgError } = await supabase
      .from('organizations')
      .select('name, tagline, host_names, address, phone, email, logo_url, cover_image_url, brand_color, kiosk_welcome_heading, kiosk_welcome_subtext, timezone, sms_credits, sms_welcome_enabled, sms_birthday_enabled, sms_missed_enabled, sms_send_to_all, sms_sender_id')
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    const { kiosk_open, active_service_id, org_name, tagline, host_names, address, phone, email, logo_url, cover_image_url, brand_color, kiosk_welcome_heading, kiosk_welcome_subtext, kiosk_access_code, timezone, sms_welcome_enabled, sms_birthday_enabled, sms_missed_enabled, sms_send_to_all, sms_sender_id } = body;
    ...
    const orgFields: Record<string, unknown> = { tagline, host_names, address, phone, email, logo_url, cover_image_url, brand_color, kiosk_welcome_heading, kiosk_welcome_subtext, timezone, sms_welcome_enabled, sms_birthday_enabled, sms_missed_enabled, sms_send_to_all, sms_sender_id };
